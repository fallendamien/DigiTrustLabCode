...
- After traditional SEO audit, consider running the **ai-seo** skill for AI visibility optimization
- Use **content-strategy** skill for broader content pillar planning beyond single keywords
- Use **copywriting** skill when drafting the actual content from briefs
- Use **copy-editing** skill to polish drafts before publishing (Seven Sweeps Framework)

## Related Skills

- **ai-seo**: For AI search optimization (getting cited by ChatGPT, Perplexity, Google AI Overviews)
- **content-strategy**: For content pillar planning and topic cluster strategy
- **schema-markup**: For implementing structured data on audit findings
- **copywriting**: For writing new content from the briefs
- **copy-editing**: For polishing existing content
- **programmatic-seo-builder**: For scaling content with templates
- **seo-audit**: For deeper technical SEO audit focus
