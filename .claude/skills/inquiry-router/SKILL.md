...
# Executive Assistant Inquiry Router (discovery bridge)

This bridge is intentionally thin. Read the canonical skill completely and
follow it as the sole source of routing logic:

`workspaces/executive-assistant/skills/inquiry-router/SKILL.md`

Do not duplicate or infer its procedures in this bridge.
