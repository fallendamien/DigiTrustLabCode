...
- Use **ai-seo** skill to ensure programmatic pages are optimized for AI search citation
- Use **schema-markup** skill for detailed structured data implementation

## Related Skills

- **ai-seo**: For optimizing programmatic pages for AI search visibility
- **schema-markup**: For implementing structured data on programmatic pages
- **content-strategy**: For planning topic clusters that programmatic pages support
- **seo-audit**: For auditing programmatic pages after deployment
- **e2e-seo-assistant**: For full SEO workflow including content briefs for programmatic pages
