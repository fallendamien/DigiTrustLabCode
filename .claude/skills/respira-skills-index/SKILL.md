...
- **File:** `.claude/skills/seo-aeo-amplifier/SKILL.md`
...
- **File:** `.claude/skills/brand-voice-synthesizer/SKILL.md`
...
- **File:** `.claude/skills/internal-link-builder/SKILL.md`
...
- **File:** `.claude/skills/stale-content-detector/SKILL.md`
...
- **File:** `.claude/skills/conversion-audit/SKILL.md`
...
- **File:** `.claude/skills/wordpress-ai-image-optimizer/SKILL.md`
...
- **File:** `.claude/skills/mobile-experience-report/SKILL.md`
...
- **File:** `.claude/skills/activity-report-composer/SKILL.md`
...
- **File:** `.claude/skills/design-system-synthesizer/SKILL.md`
...
- **File:** `.claude/skills/wordpress-site-dna/SKILL.md`
...
- **File:** `.claude/skills/technical-debt-audit/SKILL.md`
...
- **File:** `.claude/skills/prime-the-agent/SKILL.md`
