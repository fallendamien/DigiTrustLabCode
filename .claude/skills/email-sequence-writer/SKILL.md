...
- Use **lead-magnets** skill to plan what offer captures the leads before the sequence starts
- Use **copywriting** skill for the lead magnet content that precedes the email sequence

## Related Skills

- **lead-magnets**: For planning the lead capture offer that feeds into the email sequence
- **copywriting**: For writing the lead magnet content itself
- **copy-editing**: For polishing email copy before sending (Seven Sweeps Framework)
- **content-repurposer**: For turning email snippets into social media derivatives
- **content-strategy**: For broader content planning that includes email strategy
