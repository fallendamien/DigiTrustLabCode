...
## ✅ RESOLVED: Blog Archive Template 52 — Full Option C Layout (2026-07-20)
...
**Key lesson:** Query loop settings written via Respira MCP to `_bricks_data` are stored in the DB but Bricks' frontend rendering engine does NOT activate them. The Bricks GUI editor must save the template to register query loops through Bricks' internal PHP hooks. This is a Bricks limitation, not a Respira bug.
